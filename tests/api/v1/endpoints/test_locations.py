...
@patch('app.db.crud.get_locations')
...
@patch('app.db.crud.get_location')
...
@patch('app.db.crud.get_location')
@patch('app.db.crud.create_location') # Add patch for create_location
def test_create_location_success(mock_crud_create_location: Mock, mock_crud_get_location: Mock, client: TestClient) -> None: # Line (around) 62
...
@patch('app.db.crud.get_location')
@patch('app.db.crud.update_location')
def test_update_location_success(mock_crud_update_location: Mock, mock_crud_get_location: Mock, client: TestClient) -> None:
    ...
    response = client.put(f"/api/v1/locations/{existing_loc_data['id']}", json={"name": "Updated Test Location"})
    assert response.status_code == 200
...
@patch('app.db.crud.get_location')
@patch('app.db.crud.delete_location')
def test_delete_location_success(mock_crud_delete_location: Mock, mock_crud_get_location: Mock, client: TestClient) -> None:
    ...
    response = client.delete(f"/api/v1/locations/{mock_location_data['id']}")
