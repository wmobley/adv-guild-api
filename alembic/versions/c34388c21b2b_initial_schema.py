...
Revision ID: c34388c21b2b
Revises: 
Create Date: 2025-06-18 19:08:17.321850
...
def upgrade() -> None:
    ...
    sa.Column('real_world_inspiration', sa.String(length=200), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('quest_type_id', sa.Integer(), nullable=False),
    sa.Column('tags', sa.String(length=500), nullable=True),
    sa.Column('quest_giver', sa.String(length=100), nullable=True),
